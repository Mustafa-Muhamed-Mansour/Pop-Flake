...
import com.pop_flake.databinding.ItemSearchBinding
...
class SearchAdapter(
    ...
    override fun onBindViewHolder(holder: SearchViewHolder, position: Int) {
        differ.currentList[position].apply {
            holder.bind.imgItemSearch.load(this.image_thumbnail_path) {
                this.crossfade(1500)
            ...
            holder.bind.txtNameItemSearch.text = this.name
            holder.bind.txtCountryItemSearch.text = this.country
    ...
    class SearchViewHolder(binding: ItemSearchBinding) : ViewHolder(binding.root) {
        val bind = binding
    }
}